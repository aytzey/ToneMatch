...
Bu proje için model yönlendirmesi:

- Selfie ve cilt alt tonu yorum katmanı OpenRouter üzerinden `google/gemini-3-flash-preview`
- Kıyafet fotoğraflarındaki görsel analiz (Wardrobe Match, Quick Check) OpenRouter üzerinden `google/gemini-3.1-flash-lite-preview`
...
Üretim kurgusunda selfie tabanlı undertone yorumu `google/gemini-3-flash-preview`, kıyafet fotoğrafı değerlendirmeleri ise `google/gemini-3.1-flash-lite-preview` ile çalıştırılmalıdır.
