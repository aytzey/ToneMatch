jest.mock("@/assets/images/discover_hero.jpg", () => 1);
jest.mock("@/assets/images/discover_office.jpg", () => 1);
jest.mock("@/assets/images/discover_datenight.jpg", () => 1);
jest.mock("@/assets/images/discover_smartcasual.jpg", () => 1);
jest.mock("@/assets/images/gift_hero.jpg", () => 1);
jest.mock("@/assets/images/home_hero.jpg", () => 1);
jest.mock("@/assets/images/gift_cashmere_silver.jpg", () => 1);
jest.mock("@/assets/images/gift_silk_gold.jpg", () => 1);
jest.mock("@/assets/images/occasion_office_hero.jpg", () => 1);
jest.mock("@/assets/images/occasion_date_hero.jpg", () => 1);
jest.mock("@/assets/images/occasion_weekend_hero.jpg", () => 1);
